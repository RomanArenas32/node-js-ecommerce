...
const _product_order = require("./product_order");
...
function initModels(sequelize) {
  ...
  const product_order = _product_order(sequelize, DataTypes);
  ...
  product_order.belongsTo(order, { as: "order", foreignKey: "order_id"});
  order.hasMany(product_order, { as: "product_orders", foreignKey: "order_id"});
  ...
  product_order.belongsTo(product, { as: "product", foreignKey: "product_id"});
  product.hasMany(product_order, { as: "product_orders", foreignKey: "product_id"});
